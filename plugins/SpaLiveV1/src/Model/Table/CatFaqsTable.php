...
class CatFaqsTable extends Table
{
    public function initialize(array $config) : void
    {
        $this->setTable('cat_faqs'); // Name of the table in the database, if absent convention assumes lowercase version of file prefix
